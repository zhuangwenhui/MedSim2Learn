...
void test_pipeline_happy_path_tetrahedron() {
    ...
    require(result.simplify_report.skipped_within_budget,
            "tetrahedron must skip simplify under default 4 GiB budget");
    require(result.final_pressure_result.success,
            "final pressure result must be marked success");
